...
<template>
    <section class="flex md:w-2/3 w-full mx-auto m-4 p-5 flex-col justify-center">
                ...
                <div v-if="loading" class="flex mt-5 justify-center items-center w-full ">
                    <div  class="inline-block me-3 h-8 w-8 animate-spin rounded-full border-4 border-solid border-current border-e-transparent align-[-0.125em] text-white motion-reduce:animate-[spin_1.5s_linear_infinite]"
                    role="status">
                    <span
